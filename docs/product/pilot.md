...
[feature request](https://github.com/toomey-sj/sentence-app/issues/new?template=feature_request.yml) with the
...
| | When | Where |
|---|---|---|
| 🍎 **Classroom feedback** | You taught with it | [Classroom feedback issue](https://github.com/toomey-sj/sentence-app/issues/new?template=classroom_feedback.yml) |
| 🐛 **Bug report** | Something behaved wrong | [Bug report issue](https://github.com/toomey-sj/sentence-app/issues/new?template=bug_report.yml) |
| ✨ **Feature request** | Something's missing | [Feature request issue](https://github.com/toomey-sj/sentence-app/issues/new?template=feature_request.yml) |
