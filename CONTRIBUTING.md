...
1. **Use it in a class and report back.** See
   ...
   [classroom feedback issue](https://github.com/toomey-sj/sentence-app/issues/new?template=classroom_feedback.yml).
2. **Report a bug** with the lesson file attached —
   [bug report](https://github.com/toomey-sj/sentence-app/issues/new?template=bug_report.yml).
3. **Tell us a label is named wrong** for your textbook. Cheap to fix, high
   value — [feature request](https://github.com/toomey-sj/sentence-app/issues/new?template=feature_request.yml).
